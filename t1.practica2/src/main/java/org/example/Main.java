...
public class Main {
        ...
        while(!salir){
            ...
            int p=sc.nextInt();
            if(p == 1){
                protectora = ProtectoraAnimales.cargarXML(Path.of(".","t1.practica2", "src", "main", "resources", "protectoraAnimales.xml"));
            }
            if(p == 2){
                ProtectoraAnimales.guardarInformacion(protectora,Path.of(".","t1.practica2", "src", "main", "resources", "protectoraAnimales2.xml"));
            }
            if(p == 3){
